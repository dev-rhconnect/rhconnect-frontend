...
const statutConfig: Record<string, { label: string; className: string }> = {
  ...
  SOUMIS:         { label: 'Soumis (legacy)',    className: 'bg-blue-50 text-blue-700' },
  SOUMIS_RP:      { label: 'Soumis au RP',       className: 'bg-blue-50 text-blue-700' },
  VALIDE_RP:      { label: 'Validé par RP',      className: 'bg-indigo-50 text-indigo-700' },
  SOUMIS_FINANCE: { label: 'En attente Finance', className: 'bg-amber-50 text-amber-700' },
  ...
  return (
    <div>
      ...
      <div className="mb-6 flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
        <div>
          <h2 className="text-xl font-bold sm:text-2xl text-gray-900">Validation des relevés</h2>
